...
x5engine.settings.imBlog.posts['s0l4xdks'] = {
	id: 's0l4xdks',
	title: 'First Time Skiers?',
	title_tag: 'First Time Skiers? - MyBlog - bebemimado',
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://10.0.2.15:8080/blog/?lorem-ipsum",
		"image": "http://10.0.2.15:8080/blog\\files\\blog.jpg",
		"speakable": {
		...
		"itemListElement": [
			{
				"@type": "ListItem",
				"name": "MyBlog",
				"item": "http://10.0.2.15:8080/blog",
				"position": 1
			},
			{
				"@type": "ListItem",
				"name": "Septiembre 2017",
				"item": "http://10.0.2.15:8080/blog/?month=201709",
				"position": 2
			},
			{
				"@type": "ListItem",
	...
	},
	{
		...
		"itemListElement": [
			...
			},
			{
				"@type": "ListItem",
				"name": "News",
				"item": "http://10.0.2.15:8080/blog/?category=News",
				"position": 2
			},
			{
				"@type": "ListItem",
	...
	},
	{
		...
		"itemListElement": [
			...
			},
			{
				"@type": "ListItem",
				"name": "Admin",
				"item": "http://10.0.2.15:8080/blog/?author=Admin",
				"position": 2
			},
			{
				"@type": "ListItem",
	...
	},
	{
		...
		"itemListElement": [
			...
			},
			{
				"@type": "ListItem",
				"name": "News",
				"item": "http://10.0.2.15:8080/blog/?tag=News",
				"position": 2
			},
			{
				"@type": "ListItem",
	...
	timestamp: '18/9/2017',
	utc_time: new Date(2017,8,18,12,41,0),
	month: '201709',
	comments: false,
	tag: ['News']
};
if (x5engine.settings.imBlog.posts_cat['News'] == null) x5engine.settings.imBlog.posts_cat['News'] = [];
x5engine.settings.imBlog.posts_cat['News'][x5engine.settings.imBlog.posts_cat['News'].length] = 's0l4xdks';
if (x5engine.settings.imBlog.posts_author['Admin'] == null) x5engine.settings.imBlog.posts_author['Admin'] = [];
x5engine.settings.imBlog.posts_author['Admin'][x5engine.settings.imBlog.posts_author['Admin'].length] = 's0l4xdks';
if (x5engine.settings.imBlog.posts_month['201709'] == null) x5engine.settings.imBlog.posts_month['201709'] = [];
x5engine.settings.imBlog.posts_month['201709'][x5engine.settings.imBlog.posts_month['201709'].length] = 's0l4xdks';
x5engine.settings.imBlog.posts_slug['lorem-ipsum'] = 's0l4xdks';

// Post titled "Shoe finder"
x5engine.settings.imBlog.posts['000000001'] = {
	id: '000000001',
	title: 'Shoe finder',
	title_tag: 'Shoe finder - MyBlog - bebemimado',
	title_heading_tag: 'h2',
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://10.0.2.15:8080/blog/?what-running-shoes-are-fit-for-me-",
		"image": "http://10.0.2.15:8080/blog\\files\\blog_2.jpg",
		"speakable": {
			"@type": "SpeakableSpecification",
			"xpath": [
				"/html/head/meta[@name='title']/@content",
	...
	},
	{
		...
		"itemListElement": [
			...
			},
			{
				"@type": "ListItem",
				"name": "Run",
				"item": "http://10.0.2.15:8080/blog/?category=Run",
				"position": 2
			},
			{
				"@type": "ListItem",
	...
	},
	{
		...
		"itemListElement": [
			...
			},
			{
				"@type": "ListItem",
				"name": "run",
				"item": "http://10.0.2.15:8080/blog/?tag=run",
				"position": 2
			},
			{
				"@type": "ListItem",
	...
	timestamp: '14/9/2017',
	utc_time: new Date(2017,8,14,12,37,0),
	month: '201709',
	comments: false,
	tag: ['run']
};
if (x5engine.settings.imBlog.posts_cat['Run'] == null) x5engine.settings.imBlog.posts_cat['Run'] = [];
x5engine.settings.imBlog.posts_cat['Run'][x5engine.settings.imBlog.posts_cat['Run'].length] = '000000001';
if (x5engine.settings.imBlog.posts_author['Admin'] == null) x5engine.settings.imBlog.posts_author['Admin'] = [];
x5engine.settings.imBlog.posts_author['Admin'][x5engine.settings.imBlog.posts_author['Admin'].length] = '000000001';
if (x5engine.settings.imBlog.posts_month['201709'] == null) x5engine.settings.imBlog.posts_month['201709'] = [];
x5engine.settings.imBlog.posts_month['201709'][x5engine.settings.imBlog.posts_month['201709'].length] = '000000001';
x5engine.settings.imBlog.posts_slug['what-running-shoes-are-fit-for-me-'] = '000000001';

// IDs summary
x5engine.settings.imBlog.posts_ids = ['s0l4xdks', '000000001'];
